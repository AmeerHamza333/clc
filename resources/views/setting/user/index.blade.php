                              ...
                              @foreach($users as $user)
                                <tr>
                                   ...
                                   <td>
                                    ...
                                    <span class="bg-dark text-white rounded px-2" style="font-size: 13px">{{ $role->name }}</span>
                                  @endforeach
                                   </td>
                                   {{-- <td>22-05-2021</td>
                                   <td>26 Apr 1994</td>
                                   ...
                                   <td class="text-right">
                                      <div class="actions">
                                       @can('User edit')
                                         <a href="{{ route('admin.users.edit',$user->id) }}" class="btn btn-sm bg-success-light mr-2">
