                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom01"
                                                    placeholder="" name="name" value="{{ old('name',$user->name) }}"  required>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="email" class="form-control" id="validationCustom02"
                                                    placeholder="" name="email" value="{{ old('email',$user->email) }}" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" class="form-control" id="validationCustom03"
                                                    placeholder="" name="phone" value="{{ old('phone',$user->phone) }}" required>
